...
\DoxyCodeLine{00003 \textcolor{keyword}{namespace }optkit::intel::ppro\{}
\DoxyCodeLine{00004     \textcolor{keyword}{enum} ppro : uint64\_t \{}
\DoxyCodeLine{00005         CPU\_CLK\_UNHALTED = 0x79, \textcolor{comment}{// Number cycles during which the processor is not halted}}
...
\DoxyCodeLine{00018         L2\_IFETCH\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_I = 0x100, \textcolor{comment}{// Invalid state}}
\DoxyCodeLine{00019         L2\_IFETCH\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_S = 0x200, \textcolor{comment}{// Shared state}}
\DoxyCodeLine{00020         L2\_IFETCH\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_E = 0x400, \textcolor{comment}{// Exclusive state}}
\DoxyCodeLine{00021         L2\_IFETCH\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_M = 0x800, \textcolor{comment}{// Modified state}}
\DoxyCodeLine{00022         L2\_ST = 0x2a, \textcolor{comment}{// Number of L2 data stores. This event indicates that a normal}}
\DoxyCodeLine{00023         L2\_ST\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_I = 0x100, \textcolor{comment}{// Invalid state}}
\DoxyCodeLine{00024         L2\_ST\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_S = 0x200, \textcolor{comment}{// Shared state}}
\DoxyCodeLine{00025         L2\_ST\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_E = 0x400, \textcolor{comment}{// Exclusive state}}
\DoxyCodeLine{00026         L2\_ST\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_M = 0x800, \textcolor{comment}{// Modified state}}
...
\DoxyCodeLine{00029         L2\_RQSTS\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_I = 0x100, \textcolor{comment}{// Invalid state}}
\DoxyCodeLine{00030         L2\_RQSTS\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_S = 0x200, \textcolor{comment}{// Shared state}}
\DoxyCodeLine{00031         L2\_RQSTS\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_E = 0x400, \textcolor{comment}{// Exclusive state}}
\DoxyCodeLine{00032         L2\_RQSTS\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_M = 0x800, \textcolor{comment}{// Modified state}}
...
\DoxyCodeLine{00037         BUS\_DRDY\_CLOCKS\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00038         BUS\_DRDY\_CLOCKS\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
...
\DoxyCodeLine{00040         BUS\_LOCK\_CLOCKS\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00041         BUS\_LOCK\_CLOCKS\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
...
\DoxyCodeLine{00044         BUS\_TRANS\_BRD\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00045         BUS\_TRANS\_BRD\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00046         BUS\_TRANS\_RFO = 0x66, \textcolor{comment}{// Number of completed read for ownership transactions}}
\DoxyCodeLine{00047         BUS\_TRANS\_RFO\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00048         BUS\_TRANS\_RFO\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00049         BUS\_TRANS\_WB = 0x67, \textcolor{comment}{// Number of completed write back transactions}}
\DoxyCodeLine{00050         BUS\_TRANS\_WB\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00051         BUS\_TRANS\_WB\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00052         BUS\_TRAN\_IFETCH = 0x68, \textcolor{comment}{// Number of completed instruction fetch transactions}}
\DoxyCodeLine{00053         BUS\_TRAN\_IFETCH\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00054         BUS\_TRAN\_IFETCH\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00055         BUS\_TRAN\_INVAL = 0x69, \textcolor{comment}{// Number of completed invalidate transactions}}
\DoxyCodeLine{00056         BUS\_TRAN\_INVAL\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00057         BUS\_TRAN\_INVAL\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00058         BUS\_TRAN\_PWR = 0x6a, \textcolor{comment}{// Number of completed partial write transactions}}
\DoxyCodeLine{00059         BUS\_TRAN\_PWR\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00060         BUS\_TRAN\_PWR\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00061         BUS\_TRANS\_P = 0x6b, \textcolor{comment}{// Number of completed partial transactions}}
\DoxyCodeLine{00062         BUS\_TRANS\_P\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00063         BUS\_TRANS\_P\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00064         BUS\_TRANS\_IO = 0x6c, \textcolor{comment}{// Number of completed I/O transactions}}
\DoxyCodeLine{00065         BUS\_TRANS\_IO\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00066         BUS\_TRANS\_IO\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00067         BUS\_TRAN\_DEF = 0x6d, \textcolor{comment}{// Number of completed deferred transactions}}
\DoxyCodeLine{00068         BUS\_TRAN\_DEF\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00069         BUS\_TRAN\_DEF\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00070         BUS\_TRAN\_BURST = 0x6e, \textcolor{comment}{// Number of completed burst transactions}}
\DoxyCodeLine{00071         BUS\_TRAN\_BURST\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00072         BUS\_TRAN\_BURST\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
...
\DoxyCodeLine{00074         BUS\_TRAN\_ANY\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00075         BUS\_TRAN\_ANY\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
\DoxyCodeLine{00076         BUS\_TRAN\_MEM = 0x6f, \textcolor{comment}{// Number of completed memory transactions}}
\DoxyCodeLine{00077         BUS\_TRAN\_MEM\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_SELF = 0x0, \textcolor{comment}{// Clocks when processor is driving bus}}
\DoxyCodeLine{00078         BUS\_TRAN\_MEM\_\_MASK\_\_PPRO\_BUS\_DRDY\_CLOCKS\_\_ANY = 0x2000, \textcolor{comment}{// Clocks when any agent is driving bus}}
...
\DoxyCodeLine{00109         L2\_LD = 0x29, \textcolor{comment}{// Number of L2 data loads. This event indicates that a normal}}
\DoxyCodeLine{00110         L2\_LD\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_I = 0x100, \textcolor{comment}{// Invalid state}}
\DoxyCodeLine{00111         L2\_LD\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_S = 0x200, \textcolor{comment}{// Shared state}}
\DoxyCodeLine{00112         L2\_LD\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_E = 0x400, \textcolor{comment}{// Exclusive state}}
\DoxyCodeLine{00113         L2\_LD\_\_MASK\_\_PPRO\_L2\_IFETCH\_\_M = 0x800, \textcolor{comment}{// Modified state}}
\DoxyCodeLine{00114         L2\_LINES\_IN = 0x24, \textcolor{comment}{// Number of lines allocated in the L2}}
\DoxyCodeLine{00115         L2\_LINES\_OUT = 0x26, \textcolor{comment}{// Number of lines removed from the L2 for any reason}}
\DoxyCodeLine{00116         L2\_M\_LINES\_OUTM = 0x27, \textcolor{comment}{// Number of modified lines removed from the L2 for any reason}}
\DoxyCodeLine{00117         }
\DoxyCodeLine{00118     \};}
\DoxyCodeLine{00119 \};}
\DoxyCodeLine{00120 }
\DoxyCodeLine{00121 \textcolor{keyword}{namespace }ppro = optkit::intel::ppro;}
