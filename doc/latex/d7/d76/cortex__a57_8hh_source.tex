...
\DoxyCodeLine{00002 \textcolor{keyword}{namespace }optkit::arm::cortex\_a57\{}
\DoxyCodeLine{00003     \textcolor{keyword}{enum} cortex\_a57 : uint64\_t \{}
...
\DoxyCodeLine{00071         EXCEPTION\_UNDEF = 0x81, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00072         EXCEPTION\_SVC = 0x82, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00073         EXCEPTION\_PABORT = 0x83, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00074         EXCEPTION\_DABORT = 0x84, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00075         EXCEPTION\_IRQ = 0x86, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00076         EXCEPTION\_FIQ = 0x87, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00077         EXCEPTION\_SMC = 0x88, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00078         EXCEPTION\_HVC = 0x8a, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00079         EXCEPTION\_TRAP\_PABORT = 0x8b, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00080         EXCEPTION\_TRAP\_DABORT = 0x8c, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00081         EXCEPTION\_TRAP\_OTHER = 0x8d, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00082         EXCEPTION\_TRAP\_IRQ = 0x8e, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00083         EXCEPTION\_TRAP\_FIQ = 0x8f, \textcolor{comment}{// Exception taken}}
\DoxyCodeLine{00084         RC\_LD\_SPEC = 0x90, \textcolor{comment}{// Release consistency instruction speculatively executed (load-\/acquire)}}
\DoxyCodeLine{00085         RC\_ST\_SPEC = 0x91, \textcolor{comment}{// Release consistency instruction speculatively executed (store-\/release)}}
\DoxyCodeLine{00086         }
\DoxyCodeLine{00087     \};}
\DoxyCodeLine{00088 \};}
\DoxyCodeLine{00089 }
\DoxyCodeLine{00090 \textcolor{keyword}{namespace }cortex\_a57 = optkit::arm::cortex\_a57;}
