#ifndef OPTIMIZER_TOOLKIT_CORE__SRC__PLATFORMS__RENDER__OPENGL__OPENGL_BUFFER_LAYOUT_HH
#define OPTIMIZER_TOOLKIT_CORE__SRC__PLATFORMS__RENDER__OPENGL__OPENGL_BUFFER_LAYOUT_HH
