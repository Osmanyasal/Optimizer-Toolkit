#ifndef OPTIMIZER_TOOLKIT_CORE__SRC__PLATFORMS__RENDER__OPENGL__SHAPES_HH
#define OPTIMIZER_TOOLKIT_CORE__SRC__PLATFORMS__RENDER__OPENGL__SHAPES_HH
...
namespace OPTKIT::platforms::opengl::scene
{
    ...
    {
    public:
        static std::unique_ptr<opengl::render::VertexArray> tilemap2D(const glm::vec3 &size, float tile_factor = 1, const glm::vec4 &color = glm::vec4{1.0f});
