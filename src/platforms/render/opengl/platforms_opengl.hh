#ifndef OPTIMIZER_TOOLKIT_CORE__SRC__PLATFORMS__RENDER__OPENGL__PLATFORMS_OPENGL_HH
#define OPTIMIZER_TOOLKIT_CORE__SRC__PLATFORMS__RENDER__OPENGL__PLATFORMS_OPENGL_HH

#include <opengl_scene_objects.hh>
