#ifndef OPTIMIZER_TOOLKIT__SRC__PLATFORMS__RENDER__OPENGL__PLATFORMS_OPENGL_HH
#define OPTIMIZER_TOOLKIT__SRC__PLATFORMS__RENDER__OPENGL__PLATFORMS_OPENGL_HH
