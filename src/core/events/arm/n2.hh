...
namespace optkit::arm::n2{
	enum n2 : uint64_t {
		...
		L3D_CACHE_LMISS_RD = 0x400b, // Counts L3 cache long latency misses
		TRB_WRAP = 0x400c, // Counts number of time the Trace buffer current write pointer wrapped
		TRCEXTOUT0 = 0x4010, // PE Trace unit extern output 0
		TRCEXTOUT1 = 0x4011, // PE Trace unit extern output 1
		TRCEXTOUT2 = 0x4012, // PE Trace unit extern output 2
		TRCEXTOUT3 = 0x4013, // PE Trace unit extern output 3
		...
		CTI_TRIGOUT7 = 0x401b, // Cross-trigger interface output trigger r
		LDST_ALIGN_LAT = 0x4020, // Accesses with additonal latency from aligment
		LD_ALIGN_LAT = 0x4021, // Loads with additonal latency from aligment
		ST_ALIGN_LAT = 0x4022, // Stores with additonal latency from aligment
		MEM_ACCESS_CHECKED = 0x4024, // Checked data memory acess
		MEM_ACCESS_RD_CHECKED = 0x4025, // Checked data memory read acess
		MEM_ACCESS_WR_CHECKED = 0x4026, // Checked data memory write acess
		...
		FP_HP_SPEC = 0x8014, // Half precision floating-point operations sepculatively executed
		FP_SP_SPEC = 0x8018, // Single precision floating-point operations sepculatively executed
		FP_DP_SPEC = 0x801c, // Double precision floating-point operations sepculatively executed
		...
		ASE_SVE_INT8_SPEC = 0x80e3, // Operations counted by ASE_SVE_INT_SPEC where the large type is a 8-bit integer
		ASE_SVE_INT16_SPEC = 0x80e7, // Operations counted by ASE_SVE_INT_SPEC where the large type is a 16-bit integer
		ASE_SVE_INT32_SPEC = 0x80eb, // Operations counted by ASE_SVE_INT_SPEC where the large type is a 32-bit integer
		ASE_SVE_INT64_SPEC = 0x80ef, // Operations counted by ASE_SVE_INT_SPEC where the large type is a 64-bit integer
		
	};
};

namespace n2 = optkit::arm::n2;