...
namespace optkit_arm{
	enum class a64fx : uint64_t {
		...
		0INST_COMMIT = 0x0190, // This event counts every cycle that no instructions are committed
		1INST_COMMIT = 0x0191, // This event counts every cycle that one instruction is committed.
		2INST_COMMIT = 0x0192, // This event counts every cycle that two instructions are committed.
		3INST_COMMIT = 0x0193, // This event counts every cycle that three instructions are committed.
		4INST_COMMIT = 0x0194, // This event counts every cycle that four instructions are committed.
