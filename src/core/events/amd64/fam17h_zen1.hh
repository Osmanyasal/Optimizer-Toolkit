...
namespace optkit_amd64{
	enum class fam17h_zen1 : uint64_t {
		...
		L1_ITLB_MISS_L2_ITLB_MISS_MASK_IF1G = 0x4, // TBD
		L1_ITLB_MISS_L2_ITLB_MISS_MASK_IF2M = 0x2, // TBD
		L1_ITLB_MISS_L2_ITLB_MISS_MASK_IF4K = 0x1, // TBD
		...
		RETIRED_MMX_FP_INSTRUCTIONS_MASK_SSE_INSTR = 0x4, // TBD
		RETIRED_MMX_FP_INSTRUCTIONS_MASK_MMX_INSTR = 0x2, // TBD
		RETIRED_MMX_FP_INSTRUCTIONS_MASK_X87_INSTR = 0x1, // TBD
		...
		NUMBER_OF_MOVE_ELIMINATION_AND_SCALAR_OP_OPTIMIZATION_MASK_OPTIMIZED = 0x8, // Number of scalar ops optimized.
		NUMBER_OF_MOVE_ELIMINATION_AND_SCALAR_OP_OPTIMIZATION_MASK_OPT_POTENTIAL = 0x4, // Number of ops that are candidates for optimization (have z-bit either set or pass.
		NUMBER_OF_MOVE_ELIMINATION_AND_SCALAR_OP_OPTIMIZATION_MASK_SSE_MOV_OPS_ELIM = 0x2, // Number of SSE move ops eliminated.
		NUMBER_OF_MOVE_ELIMINATION_AND_SCALAR_OP_OPTIMIZATION_MASK_SSE_MOV_OPS = 0x1, // Number of SSE move ops.
		...
		RETIRED_SSE_AVX_OPERATIONS_MASK_DP_MULT_ADD_FLOPS = 0x80, // Double precision multiply-add flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_DP_DIV_FLOPS = 0x40, // Double precision divide/square root flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_DP_MULT_FLOPS = 0x20, // Double precision multiply flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_DP_ADD_SUB_FLOPS = 0x10, // Double precision add/subtract flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_SP_MULT_ADD_FLOPS = 0x8, // Single precision multiply-add flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_SP_DIV_FLOPS = 0x4, // Single precision divide/square root flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_SP_MULT_FLOPS = 0x2, // Single precision multiply flops.
		RETIRED_SSE_AVX_OPERATIONS_MASK_SP_ADD_SUB_FLOPS = 0x1, // Single precision add/subtract flops.
		RETIRED_SERIALIZING_OPS = 0x5, // The number of serializing Ops retired.
		RETIRED_SERIALIZING_OPS_MASK_X87_CTRL_RET = 0x8, // X87 control word mispredict traps due to mispredction in RC or PC
		RETIRED_SERIALIZING_OPS_MASK_X87_BOT_RET = 0x4, // X87 bottom-executing uops retired.
		RETIRED_SERIALIZING_OPS_MASK_SSE_CTRL_RET = 0x2, // SSE control word mispreduct traps due to mispredctions in RC
		RETIRED_SERIALIZING_OPS_MASK_SSE_BOT_RET = 0x1, // SSE bottom-executing uops retired.
		...
		RETIRED_X87_FLOATING_POINT_OPERATIONS_MASK_DIV_SQR_R_OPS = 0x4, // Divide and square root ops
		RETIRED_X87_FLOATING_POINT_OPERATIONS_MASK_MUL_OPS = 0x2, // Multiple ops
		RETIRED_X87_FLOATING_POINT_OPERATIONS_MASK_ADD_SUB_OPS = 0x1, // Add/subtract ops
		...
		FPU_PIPE_ASSIGNMENT_MASK_DUAL3 = 0x80, // Total number of multi-pipe uops assigned to pipe3
		FPU_PIPE_ASSIGNMENT_MASK_DUAL2 = 0x40, // Total number of multi-pipe uops assigned to pipe2
		FPU_PIPE_ASSIGNMENT_MASK_DUAL1 = 0x20, // Total number of multi-pipe uops assigned to pipe1
		FPU_PIPE_ASSIGNMENT_MASK_DUAL0 = 0x10, // Total number of multi-pipe uops assigned to pipe0
		FPU_PIPE_ASSIGNMENT_MASK_TOTAL3 = 0x8, // Total number of uops assigned to pipe3
		FPU_PIPE_ASSIGNMENT_MASK_TOTAL2 = 0x4, // Total number of uops assigned to pipe2
		FPU_PIPE_ASSIGNMENT_MASK_TOTAL1 = 0x2, // Total number of uops assigned to pipe1
		FPU_PIPE_ASSIGNMENT_MASK_TOTAL0 = 0x1, // Total number of uops assigned to pipe0
		...
		INSTRUCTION_CACHE_LINES_INVALIDATED_MASK_L2_INVALIDATING_PROBE = 0x2, // IC line invalidated due to L2 invalidating probe (external or LS).
		INSTRUCTION_CACHE_LINES_INVALIDATED_MASK_FILL_INVALIDATED = 0x1, // IC line invalidated due to overwriting fill response.
		INSTRUCTION_PIPE_STALL = 0x87, // TBD
		INSTRUCTION_PIPE_STALL_MASK_IC_STALL_ANY = 0x4, // IC pipe was stalled during this clock cycle for any reason (nothing valud in pipe ICM1).
		INSTRUCTION_PIPE_STALL_MASK_IC_STALL_DQ_EMPTY = 0x2, // IC pipe was stalled during this clock cycle (including IC to OC fetches) due to DQ empty.
		INSTRUCTION_PIPE_STALL_MASK_IC_STALL_BACK_PRESSURE = 0x1, // IC pipe was stalled during this clock cycle (ncluding IC to OC fetches) due to back pressure.
		32_BYTE_INSTRUCTION_CACHE_FETCH = 0x80, // The number of 32B fetch windows transferred from IC pipe to DE instruction decoder (includes non-cacheable and cacheable fill responses).
		32_BYTE_INSTRUCTION_CACHE_MISSES = 0x81, // The number of 32B fetch windows tried to read the L1 IC and missed in the full tag.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS = 0x64, // This event does not count accesses to the L2 cache by the L2 prefetcher
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_LS_RD_BLK_C_S = 0x80, // Load/Store ReadBlock C/S hit
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_LS_RD_BLK_L_HIT_X = 0x40, // Load/Store Readblock L hit eXclusive.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_LS_RD_BLK_L_HIT_S = 0x20, // Load/Store ReadBlock L hit Shared.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_LS_RD_BLK_X = 0x10, // Load/Store ReadblockX/ChangeToX hit eXclusive.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_LS_RD_BLK_C = 0x8, // Load/Store ReadBlock C S L X Change To X Miss.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_IC_FILL_HIT_X = 0x4, // Icache fill hit eXclusive.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_IC_FILL_HIT_S = 0x2, // Icache fill hit Shared.
		CORE_TO_L2_CACHEABLE_REQUEST_ACCESS_STATUS_MASK_IC_FILL_MISS = 0x1, // Icache fill miss.
		CYCLES_WITH_FILL_PENDING_FROM_L2 = 0x6d, // Total cycles spent with one or more fill requests in flight from L2.
		CYCLES_WITH_FILL_PENDING_FROM_L2_MASK_L2_FILL_BUSY = 0x1, // TBD
		L2_LATENCY = 0x62, // Total cycles spent waiting for L2 fills to complete from L3 or memory
		L2_LATENCY_MASK_L2_CYCLES_WAITING_ON_FILLS = 0x1, // TBD
		REQUESTS_TO_L2_GROUP1 = 0x60, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_RD_BLK_L = 0x80, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_RD_BLK_X = 0x40, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_LS_RD_BLK_C_S = 0x20, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_CACHEABLE_IC_READ = 0x10, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_CHANGE_TO_X = 0x8, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_PREFETCH_L2 = 0x4, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_L2_HW_PF = 0x2, // TBD
		REQUESTS_TO_L2_GROUP1_MASK_OTHER_REQUESTS = 0x1, // TBD
		REQUESTS_TO_L2_GROUP2 = 0x61, // Multi-events in that LS and IF requests can be received simultaneous.
		REQUESTS_TO_L2_GROUP2_MASK_GROUP1 = 0x80, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_LS_RD_SIZED = 0x40, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_LS_RD_SIZED_N_C = 0x20, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_IC_RD_SIZED = 0x10, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_IC_RD_SIZED_N_C = 0x8, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_SMC_INVAL = 0x4, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_BUS_LOCKS_ORIGINATOR = 0x2, // TBD
		REQUESTS_TO_L2_GROUP2_MASK_BUS_LOCKS_RESPONSES = 0x1, // TBD
		LS_TO_L2_WBC_REQUESTS = 0x63, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_WCB_WRITE = 0x40, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_WCB_CLOSE = 0x20, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_CACHE_LINE_FLUSH = 0x10, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_I_LINE_FLUSH = 0x8, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_ZERO_BYTE_STORE = 0x4, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_LOCAL_IC_CLR = 0x2, // TBD
		LS_TO_L2_WBC_REQUESTS_MASK_C_L_ZERO = 0x1, // TBD
		...
		LS_DISPATCH_MASK_LD_ST_DISPATCH = 0x4, // Load/Store uops dispatched.
		...
		INEFFECTIVE_SOFTWARE_PREFETCH_MASK_MAB_MCH_CNT = 0x2, // TBD
		INEFFECTIVE_SOFTWARE_PREFETCH_MASK_DATA_PIPE_SW_PF_DC_HIT = 0x1, // TBD
		...
		SOFTWARE_PREFETCH_DATA_CACHE_FILLS_MASK_LS_MABRESP_LCL_RMT_CACHE = 0x10, // Fill from another cache (home node remote).
		SOFTWARE_PREFETCH_DATA_CACHE_FILLS_MASK_LS_MABRESP_LCL_RMT_DRAM = 0x40, // Fill from DRAM (home node remote).
		...
		HARDWARE_PREFETCH_DATA_CACHE_FILLS_MASK_LS_MABRESP_LCL_RMT_CACHE = 0x10, // Fill from another cache (home node remote).
		HARDWARE_PREFETCH_DATA_CACHE_FILLS_MASK_LS_MABRESP_LCL_RMT_DRAM = 0x40, // Fill from DRAM (home node remote).
		L1_DTLB_MISS = 0x45, // L1 Data TLB misses.
		L1_DTLB_MISS_MASK_TLB_RELOAD_1G_L2_MISS = 0x80, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_2M_L2_MISS = 0x40, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_COALESCED_PAGE_MISS = 0x20, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_4K_L2_MISS = 0x10, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_1G_L2_HIT = 0x8, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_2M_L2_HIT = 0x4, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_COALESCED_PAGE_HIT = 0x2, // TBD
		L1_DTLB_MISS_MASK_TLB_RELOAD_4K_L2_HIT = 0x1, // TBD
		LOCKS = 0x25, // Lock operations. Unit masks ORed
		LOCKS_MASK_SPEC_LOCK_MAP_COMMIT = 0x8, // TBD
		LOCKS_MASK_SPEC_LOCK = 0x4, // TBD
		LOCKS_MASK_NON_SPEC_LOCK = 0x2, // TBD
		LOCKS_MASK_BUS_LOCK = 0x1, // TBD
		...
		PREFETCH_INSTRUCTIONS_DISPATCHED_MASK_PREFETCH_NTA = 0x4, // Non-temporal prefetches.
		PREFETCH_INSTRUCTIONS_DISPATCHED_MASK_STORE_PREFETCH_W = 0x2, // TBD
		PREFETCH_INSTRUCTIONS_DISPATCHED_MASK_LOAD_PREFETCH_W = 0x1, // TBD
		STORE_TO_LOAD_FORWARD = 0x35, // Number of STore Lad Forward hits.
		TABLEWALKER_ALLOCATION = 0x46, // TBD
		TABLEWALKER_ALLOCATION_MASK_ALLOC_ISIDE1 = 0x8, // TBD
		TABLEWALKER_ALLOCATION_MASK_ALLOC_ISIDE0 = 0x4, // TBD
		TABLEWALKER_ALLOCATION_MASK_ALLOC_DSIDE1 = 0x2, // TBD
		TABLEWALKER_ALLOCATION_MASK_ALLOC_DSIDE0 = 0x1, // TBD
		L1_BTB_CORRECTION = 0x8a, // TBD
		L2_BTB_CORRECTION = 0x8b, // TBD
		OC_MODE_SWITCH = 0x28a, // TBD
		OC_MODE_SWITCH_MASK_OC_IC_MODE_SWITCH = 0x2, // TBD
		OC_MODE_SWITCH_MASK_IC_OC_MODE_SWITCH = 0x1, // TBD
		...
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_RETIRE_TOKEN_STALL = 0x40, // Retire tokens unavailable
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_AGSQ_TOKEN_STALL = 0x20, // AGSQ tokens unavailable
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_ALU_TOKEN_STALL = 0x10, // ALU tokens unavailable
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_ALSQ3_0_TOKEN_STALL = 0x8, // TBD
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_ALSQ3_TOKEN_STALL = 0x4, // ALSQ3 tokens unavailable
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_ALSQ2_TOKEN_STALL = 0x2, // ALSQ2 tokens unavailable
		DYNAMIC_TOKENS_DISPATCH_STALLS_CYCLES_0_MASK_ALSQ1_TOKEN_STALL = 0x1, // ALSQ1 tokens unavailable
		...
		L2_PREFETCH_HIT_L2_MASK_ANY = 0x3f, // Any L2 prefetch requests
		L2_PREFETCH_HIT_L3 = 0x71, // Number of L2 prefetcher hits in the L3
		L2_PREFETCH_HIT_L3_MASK_ANY = 0x3f, // Any L2 prefetch requests
		L2_PREFETCH_MISS_L3 = 0x72, // Number of L2 prefetcher misses in the L3
		L2_PREFETCH_MISS_L3_MASK_ANY = 0x3f, // Any L2 prefetch requests
