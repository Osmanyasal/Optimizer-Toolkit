...
namespace optkit_amd64{
	enum class fam10h : uint64_t {
		...
		L1_DTLB_MISS_AND_L2_DTLB_HIT_MASK_ALL = 0x3, // All sub-events selected
		...
		SCRUBBER_SINGLE_BIT_ECC_ERRORS_MASK_LOAD_PIPE_ERROR = 0x4, // Load pipe error
		SCRUBBER_SINGLE_BIT_ECC_ERRORS_MASK_STORE_WRITE_PIPE_ERROR = 0x8, // Store write pipe error
		SCRUBBER_SINGLE_BIT_ECC_ERRORS_MASK_ALL = 0xf, // All sub-events selected
		...
		MAB_REQUESTS_MASK_BUFFER_0 = 0x0, // Buffer 0
		MAB_REQUESTS_MASK_BUFFER_1 = 0x1, // Buffer 1
		MAB_REQUESTS_MASK_BUFFER_2 = 0x2, // Buffer 2
		MAB_REQUESTS_MASK_BUFFER_3 = 0x3, // Buffer 3
		MAB_REQUESTS_MASK_BUFFER_4 = 0x4, // Buffer 4
		MAB_REQUESTS_MASK_BUFFER_5 = 0x5, // Buffer 5
		MAB_REQUESTS_MASK_BUFFER_6 = 0x6, // Buffer 6
		MAB_REQUESTS_MASK_BUFFER_7 = 0x7, // Buffer 7
		MAB_REQUESTS_MASK_BUFFER_8 = 0x8, // Buffer 8
		MAB_REQUESTS_MASK_BUFFER_9 = 0x9, // Buffer 9
		...
		MAB_WAIT_CYCLES_MASK_BUFFER_0 = 0x0, // Buffer 0
		MAB_WAIT_CYCLES_MASK_BUFFER_1 = 0x1, // Buffer 1
		MAB_WAIT_CYCLES_MASK_BUFFER_2 = 0x2, // Buffer 2
		MAB_WAIT_CYCLES_MASK_BUFFER_3 = 0x3, // Buffer 3
		MAB_WAIT_CYCLES_MASK_BUFFER_4 = 0x4, // Buffer 4
		MAB_WAIT_CYCLES_MASK_BUFFER_5 = 0x5, // Buffer 5
		MAB_WAIT_CYCLES_MASK_BUFFER_6 = 0x6, // Buffer 6
		MAB_WAIT_CYCLES_MASK_BUFFER_7 = 0x7, // Buffer 7
		MAB_WAIT_CYCLES_MASK_BUFFER_8 = 0x8, // Buffer 8
		MAB_WAIT_CYCLES_MASK_BUFFER_9 = 0x9, // Buffer 9
		...
		SYSTEM_READ_RESPONSES_MASK_ALL = 0x1f, // All sub-events selected
		QUADWORDS_WRITTEN_TO_SYSTEM = 0x6d, // Octwords Written to System
		QUADWORDS_WRITTEN_TO_SYSTEM_MASK_QUADWORD_WRITE_TRANSFER = 0x1, // Octword write transfer
		...
		RETIRED_MMX_AND_FP_INSTRUCTIONS_MASK_PACKED_SSE_AND_SSE2 = 0x4, // SSE instructions (SSE
		...
		RETIRED_FASTPATH_DOUBLE_OP_INSTRUCTIONS_MASK_ALL = 0x7, // All sub-events selected
		...
		DRAM_ACCESSES_PAGE_MASK_ALL = 0x3f, // All sub-events selected
		MEMORY_CONTROLLER_PAGE_TABLE_OVERFLOWS = 0xe1, // DRAM Controller Page Table Overflows
		MEMORY_CONTROLLER_PAGE_TABLE_OVERFLOWS_MASK_DCT0_PAGE_TABLE_OVERFLOW = 0x1, // DCT0 Page Table Overflow
		MEMORY_CONTROLLER_PAGE_TABLE_OVERFLOWS_MASK_DCT1_PAGE_TABLE_OVERFLOW = 0x2, // DCT1 Page Table Overflow
		MEMORY_CONTROLLER_PAGE_TABLE_OVERFLOWS_MASK_ALL = 0x3, // All sub-events selected
		MEMORY_CONTROLLER_SLOT_MISSES = 0xe2, // Memory Controller DRAM Command Slots Missed
		MEMORY_CONTROLLER_SLOT_MISSES_MASK_DCT0_COMMAND_SLOTS_MISSED = 0x1, // DCT0 Command Slots Missed
		MEMORY_CONTROLLER_SLOT_MISSES_MASK_DCT1_COMMAND_SLOTS_MISSED = 0x2, // DCT1 Command Slots Missed
		MEMORY_CONTROLLER_SLOT_MISSES_MASK_ALL = 0x3, // All sub-events selected
		MEMORY_CONTROLLER_TURNAROUNDS = 0xe3, // Memory Controller Turnarounds
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_CHIP_SELECT = 0x1, // DCT0 DIMM (chip select) turnaround
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_READ_TO_WRITE = 0x2, // DCT0 Read to write turnaround
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_WRITE_TO_READ = 0x4, // DCT0 Write to read turnaround
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_DCT1_DIMM = 0x8, // DCT1 DIMM (chip select) turnaround
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_DCT1_READ_TO_WRITE_TURNAROUND = 0x10, // DCT1 Read to write turnaround
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_DCT1_WRITE_TO_READ_TURNAROUND = 0x20, // DCT1 Write to read turnaround
		...
		MEMORY_CONTROLLER_BYPASS_MASK_LOW_PRIORITY = 0x2, // Memory controller medium priority bypass
		MEMORY_CONTROLLER_BYPASS_MASK_DRAM_INTERFACE = 0x4, // DCT0 DCQ bypass
		MEMORY_CONTROLLER_BYPASS_MASK_DRAM_QUEUE = 0x8, // DCT1 DCQ bypass
		MEMORY_CONTROLLER_BYPASS_MASK_ALL = 0xf, // All sub-events selected
		THERMAL_STATUS_AND_ECC_ERRORS = 0xe8, // Thermal Status
		THERMAL_STATUS_AND_ECC_ERRORS_MASK_CLKS_DIE_TEMP_TOO_HIGH = 0x4, // Number of times the HTC trip point is crossed
		THERMAL_STATUS_AND_ECC_ERRORS_MASK_CLKS_TEMP_THRESHOLD_EXCEEDED = 0x8, // Number of clocks when STC trip point active
		THERMAL_STATUS_AND_ECC_ERRORS_MASK_STC_TRIP_POINTS_CROSSED = 0x10, // Number of times the STC trip point is crossed
		THERMAL_STATUS_AND_ECC_ERRORS_MASK_CLOCKS_HTC_P_STATE_INACTIVE = 0x20, // Number of clocks HTC P-state is inactive.
		THERMAL_STATUS_AND_ECC_ERRORS_MASK_CLOCKS_HTC_P_STATE_ACTIVE = 0x40, // Number of clocks HTC P-state is active
		THERMAL_STATUS_AND_ECC_ERRORS_MASK_ALL = 0x7c, // All sub-events selected
		...
		PROBE_MASK_UPSTREAM_DISPLAY_REFRESH_READS = 0x10, // Upstream display refresh/ISOC reads
		PROBE_MASK_UPSTREAM_NON_DISPLAY_REFRESH_READS = 0x20, // Upstream non-display refresh reads
		PROBE_MASK_UPSTREAM_WRITES = 0x40, // Upstream ISOC writes
		PROBE_MASK_UPSTREAM_NON_ISOC_WRITES = 0x80, // Upstream non-ISOC writes
		PROBE_MASK_ALL = 0xff, // All sub-events selected
		GART = 0xee, // GART Events
		GART_MASK_APERTURE_HIT_FROM_CPU = 0x1, // GART aperture hit on access from CPU
		GART_MASK_APERTURE_HIT_FROM_IO = 0x2, // GART aperture hit on access from IO
		GART_MASK_MISS = 0x4, // GART miss
		GART_MASK_REQUEST_HIT_TABLE_WALK = 0x8, // GART/DEV Request hit table walk in progress
		GART_MASK_DEV_HIT = 0x10, // DEV hit
		GART_MASK_DEV_MISS = 0x20, // DEV miss
		GART_MASK_DEV_ERROR = 0x40, // DEV error
		GART_MASK_MULTIPLE_TABLE_WALK = 0x80, // GART/DEV multiple table walk in progress
		GART_MASK_ALL = 0xff, // All sub-events selected
		MEMORY_CONTROLLER_REQUESTS = 0x1f0, // Memory Controller Requests
		MEMORY_CONTROLLER_REQUESTS_MASK_WRITE_REQUESTS = 0x1, // Write requests sent to the DCT
		MEMORY_CONTROLLER_REQUESTS_MASK_READ_REQUESTS = 0x2, // Read requests (including prefetch requests) sent to the DCT
		MEMORY_CONTROLLER_REQUESTS_MASK_PREFETCH_REQUESTS = 0x4, // Prefetch requests sent to the DCT
		...
		MEMORY_CONTROLLER_REQUESTS_MASK_READ_REQUESTS_WHILE_WRITES_REQUESTS = 0x80, // Read requests sent to the DCT while writes requests are pending in the DCT
		...
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_0 = 0x1, // From Local node to Node 0
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_1 = 0x2, // From Local node to Node 1
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_2 = 0x4, // From Local node to Node 2
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_3 = 0x8, // From Local node to Node 3
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_4 = 0x10, // From Local node to Node 4
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_5 = 0x20, // From Local node to Node 5
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_6 = 0x40, // From Local node to Node 6
		CPU_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_7 = 0x80, // From Local node to Node 7
		...
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_0 = 0x1, // From Local node to Node 0
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_1 = 0x2, // From Local node to Node 1
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_2 = 0x4, // From Local node to Node 2
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_3 = 0x8, // From Local node to Node 3
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_4 = 0x10, // From Local node to Node 4
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_5 = 0x20, // From Local node to Node 5
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_6 = 0x40, // From Local node to Node 6
		IO_TO_DRAM_REQUESTS_TO_TARGET_NODE_MASK_LOCAL_TO_7 = 0x80, // From Local node to Node 7
		...
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_READ_BLOCK = 0x1, // Read block
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_READ_BLOCK_SHARED = 0x2, // Read block shared
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_READ_BLOCK_MODIFIED = 0x4, // Read block modified
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_CHANGE_TO_DIRTY = 0x8, // Change-to-Dirty
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_0 = 0x10, // From Local node to Node 0
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_1 = 0x20, // From Local node to Node 1
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_2 = 0x40, // From Local node to Node 2
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_3 = 0x80, // From Local node to Node 3
		...
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_READ_BLOCK = 0x1, // Read block
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_READ_BLOCK_SHARED = 0x2, // Read block shared
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_READ_BLOCK_MODIFIED = 0x4, // Read block modified
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_CHANGE_TO_DIRTY = 0x8, // Change-to-Dirty
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_0 = 0x10, // From Local node to Node 0
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_1 = 0x20, // From Local node to Node 1
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_2 = 0x40, // From Local node to Node 2
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_0_3_MASK_LOCAL_TO_3 = 0x80, // From Local node to Node 3
		...
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_READ_BLOCK = 0x1, // Read block
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_READ_BLOCK_SHARED = 0x2, // Read block shared
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_READ_BLOCK_MODIFIED = 0x4, // Read block modified
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_CHANGE_TO_DIRTY = 0x8, // Change-to-Dirty
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_4 = 0x10, // From Local node to Node 4
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_5 = 0x20, // From Local node to Node 5
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_6 = 0x40, // From Local node to Node 6
		CPU_READ_COMMAND_LATENCY_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_7 = 0x80, // From Local node to Node 7
		...
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_READ_BLOCK = 0x1, // Read block
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_READ_BLOCK_SHARED = 0x2, // Read block shared
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_READ_BLOCK_MODIFIED = 0x4, // Read block modified
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_CHANGE_TO_DIRTY = 0x8, // Change-to-Dirty
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_4 = 0x10, // From Local node to Node 4
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_5 = 0x20, // From Local node to Node 5
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_6 = 0x40, // From Local node to Node 6
		CPU_READ_COMMAND_REQUESTS_TO_TARGET_NODE_4_7_MASK_LOCAL_TO_7 = 0x80, // From Local node to Node 7
		...
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_READ_SIZED = 0x1, // Read Sized
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_WRITE_SIZED = 0x2, // Write Sized
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_VICTIM_BLOCK = 0x4, // Victim Block
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_NODE_GROUP_SELECT = 0x8, // Nodes 4-7.
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_0_4 = 0x10, // From Local node to Node 0/4
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_1_5 = 0x20, // From Local node to Node 1/5
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_2_6 = 0x40, // From Local node to Node 2/6
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_3_7 = 0x80, // From Local node to Node 3/7
		CPU_COMMAND_LATENCY_TO_TARGET_NODE_0_3_4_7_MASK_ALL = 0xff, // All sub-events selected
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7 = 0x1e7, // CPU Requests to Target Node 0-3/4-7
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_READ_SIZED = 0x1, // Read Sized
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_WRITE_SIZED = 0x2, // Write Sized
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_VICTIM_BLOCK = 0x4, // Victim Block
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_NODE_GROUP_SELECT = 0x8, // Nodes 4-7.
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_0_4 = 0x10, // From Local node to Node 0/4
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_1_5 = 0x20, // From Local node to Node 1/5
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_2_6 = 0x40, // From Local node to Node 2/6
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_LOCAL_TO_3_7 = 0x80, // From Local node to Node 3/7
		CPU_REQUESTS_TO_TARGET_NODE_0_3_4_7_MASK_ALL = 0xff, // All sub-events selected
		...
		HYPERTRANSPORT_LINK0_MASK_NOP_DWORD_SENT = 0x8, // Nop DW sent (idle)
		HYPERTRANSPORT_LINK0_MASK_ADDRESS_EXT_DWORD_SENT = 0x10, // Address extension DWORD sent
		HYPERTRANSPORT_LINK0_MASK_PER_PACKET_CRC_SENT = 0x20, // Per packet CRC sent
		HYPERTRANSPORT_LINK0_MASK_ALL = 0x3f, // All sub-events selected
		HYPERTRANSPORT_LINK0_MASK_SUBLINK_MASK = 0x80, // SubLink Mask
		...
		HYPERTRANSPORT_LINK1_MASK_NOP_DWORD_SENT = 0x8, // Nop DW sent (idle)
		HYPERTRANSPORT_LINK1_MASK_ADDRESS_EXT_DWORD_SENT = 0x10, // Address extension DWORD sent
		HYPERTRANSPORT_LINK1_MASK_PER_PACKET_CRC_SENT = 0x20, // Per packet CRC sent
		HYPERTRANSPORT_LINK1_MASK_ALL = 0x3f, // All sub-events selected
		HYPERTRANSPORT_LINK1_MASK_SUBLINK_MASK = 0x80, // SubLink Mask
		...
		HYPERTRANSPORT_LINK2_MASK_NOP_DWORD_SENT = 0x8, // Nop DW sent (idle)
		HYPERTRANSPORT_LINK2_MASK_ADDRESS_EXT_DWORD_SENT = 0x10, // Address extension DWORD sent
		HYPERTRANSPORT_LINK2_MASK_PER_PACKET_CRC_SENT = 0x20, // Per packet CRC sent
		HYPERTRANSPORT_LINK2_MASK_ALL = 0x3f, // All sub-events selected
		HYPERTRANSPORT_LINK2_MASK_SUBLINK_MASK = 0x80, // SubLink Mask
		HYPERTRANSPORT_LINK3 = 0x1f9, // HyperTransport Link 3 Transmit Bandwidth
		HYPERTRANSPORT_LINK3_MASK_COMMAND_DWORD_SENT = 0x1, // Command DWORD sent
		HYPERTRANSPORT_LINK3_MASK_DATA_DWORD_SENT = 0x2, // Data DWORD sent
		HYPERTRANSPORT_LINK3_MASK_BUFFER_RELEASE_DWORD_SENT = 0x4, // Buffer release DWORD sent
		HYPERTRANSPORT_LINK3_MASK_NOP_DWORD_SENT = 0x8, // Nop DW sent (idle)
		HYPERTRANSPORT_LINK3_MASK_ADDRESS_EXT_DWORD_SENT = 0x10, // Address DWORD sent
		HYPERTRANSPORT_LINK3_MASK_PER_PACKET_CRC_SENT = 0x20, // Per packet CRC sent
		HYPERTRANSPORT_LINK3_MASK_ALL = 0x3f, // All sub-events selected
		HYPERTRANSPORT_LINK3_MASK_SUBLINK_MASK = 0x80, // SubLink Mask
		...
		READ_REQUEST_TO_L3_CACHE_MASK_ANY_READ = 0x7, // Any read modes (exclusive
		READ_REQUEST_TO_L3_CACHE_MASK_ALL_CORES = 0xf0, // All sub-events selected
		...
		L3_CACHE_MISSES_MASK_ANY_READ = 0x7, // Any read modes (exclusive
		L3_CACHE_MISSES_MASK_ALL_CORES = 0xf0, // All cores
		...
		L3_FILLS_CAUSED_BY_L2_EVICTIONS_MASK_ANY_STATE = 0xf, // Any line state (shared
		L3_FILLS_CAUSED_BY_L2_EVICTIONS_MASK_ALL_CORES = 0xf0, // All cores
		...
		READ_REQUEST_TO_L3_CACHE_MASK_READ_BLOCK_MODIFY = 0x4, // Read Block Modify
		READ_REQUEST_TO_L3_CACHE_MASK_ANY_READ = 0x7, // Any read modes (exclusive
		READ_REQUEST_TO_L3_CACHE_MASK_ALL_CORES = 0xf0, // All cores
		L3_CACHE_MISSES_MASK_READ_BLOCK_EXCLUSIVE = 0x1, // Read Block Exclusive (Data cache read)
		L3_CACHE_MISSES_MASK_READ_BLOCK_SHARED = 0x2, // Read Block Shared (Instruction cache read)
		L3_CACHE_MISSES_MASK_READ_BLOCK_MODIFY = 0x4, // Read Block Modify
		L3_CACHE_MISSES_MASK_ANY_READ = 0x7, // Any read modes (exclusive
		...
		NON_CANCELLED_L3_READ_REQUESTS_MASK_READ_BLOCK_EXCLUSIVE = 0x1, // Read Block Exclusive (Data cache read)
		NON_CANCELLED_L3_READ_REQUESTS_MASK_READ_BLOCK_SHARED = 0x2, // Read Block Shared (Instruction cache read)
		NON_CANCELLED_L3_READ_REQUESTS_MASK_READ_BLOCK_MODIFY = 0x4, // Read Block Modify
		NON_CANCELLED_L3_READ_REQUESTS_MASK_ANY_READ = 0x7, // Any read modes (exclusive
		NON_CANCELLED_L3_READ_REQUESTS_MASK_ALL_CORES = 0xf0, // All cores
