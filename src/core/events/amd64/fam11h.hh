...
namespace optkit_amd64{
	enum class fam11h : uint64_t {
		...
		SYSTEM_READ_RESPONSES_MASK_ALL = 0x17, // All sub-events selected
		...
		REQUESTS_TO_L2_MASK_ALL = 0x1f, // All sub-events selected
		...
		L2_CACHE_MISS_MASK_ALL = 0x7, // All sub-events selected
		...
		RETIRED_MMX_AND_FP_INSTRUCTIONS_MASK_ALL = 0xf, // All sub-events selected
		...
		DRAM_ACCESSES_MASK_WRITE_REQUEST = 0x40, // Write request.
		DRAM_ACCESSES_MASK_READ_REQUEST = 0x80, // Read request.
		DRAM_ACCESSES_MASK_ALL = 0xff, // All sub-events selected
		DRAM_CONTROLLER_PAGE_TABLE_EVENTS = 0xe1, // DRAM Controller Page Table Events
		DRAM_CONTROLLER_PAGE_TABLE_EVENTS_MASK_DCT_PAGE_TABLE_OVERFLOW = 0x1, // DCT Page Table Overflow
		DRAM_CONTROLLER_PAGE_TABLE_EVENTS_MASK_STALE_TABLE_ENTRY_HITS = 0x2, // Number of stale table entry hits. (hit on a page closed too soon).
		DRAM_CONTROLLER_PAGE_TABLE_EVENTS_MASK_PAGE_TABLE_IDLE_CYCLE_LIMIT_INCREMENTED = 0x4, // Page table idle cycle limit incremented.
		DRAM_CONTROLLER_PAGE_TABLE_EVENTS_MASK_PAGE_TABLE_IDLE_CYCLE_LIMIT_DECREMENTED = 0x8, // Page table idle cycle limit decremented.
		DRAM_CONTROLLER_PAGE_TABLE_EVENTS_MASK_ALL = 0xf, // All sub-events selected
		...
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_DCT0_DIMM = 0x4, // DCT0 DIMM (chip select) turnaround
		...
		MEMORY_CONTROLLER_TURNAROUNDS_MASK_DCT1_DIMM = 0x20, // DCT1 DIMM (chip select) turnaround
		...
		MEMORY_CONTROLLER_RBD_QUEUE_MASK_COUNTER_REACHED = 0x4, // F2x[1
		MEMORY_CONTROLLER_RBD_QUEUE_MASK_ALL = 0x4, // All sub-events selected
		THERMAL_STATUS = 0xe8, // Thermal Status
		THERMAL_STATUS_MASK_MEMHOT_L_ASSERTIONS = 0x1, // Number of clocks MEMHOT_L is asserted.
		...
		CPU_IO_REQUESTS_TO_MEMORY_IO_MASK_I_O_TO_I_O = 0xa1, // IO to IO
		CPU_IO_REQUESTS_TO_MEMORY_IO_MASK_I_O_TO_MEM = 0xa2, // IO to Mem
		CPU_IO_REQUESTS_TO_MEMORY_IO_MASK_CPU_TO_I_O = 0xa4, // CPU to IO
		CPU_IO_REQUESTS_TO_MEMORY_IO_MASK_CPU_TO_MEM = 0xa8, // CPU to Mem
		CPU_IO_REQUESTS_TO_MEMORY_IO_MASK_ALL = 0xaf, // All sub-events selected
		...
		PROBE_MASK_UPSTREAM_ISOC_WRITES = 0x40, // Upstream ISOC writes.
		...
		HYPERTRANSPORT_LINK0_MASK_ADDRESS_DWORD_SENT = 0x2, // Address DWORD sent
		HYPERTRANSPORT_LINK0_MASK_DATA_DWORD_SENT = 0x4, // Data DWORD sent
		HYPERTRANSPORT_LINK0_MASK_BUFFER_RELEASE_DWORD_SENT = 0x8, // Buffer release DWORD sent
		HYPERTRANSPORT_LINK0_MASK_NOP_DWORD_SENT = 0x10, // Nop DW sent (idle)
		...
		SIDEBAND_SIGNALS_MASK_HALT = 0x1, // HALT
		...
		SIDEBAND_SIGNALS_MASK_ALL = 0x1f, // All sub-events selected
