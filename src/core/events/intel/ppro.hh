...
namespace optkit::intel::ppro{
	enum ppro : uint64_t {
		...
		L2_IFETCH__MASK__PPRO_L2_IFETCH__I = 0x100, // Invalid state
		L2_IFETCH__MASK__PPRO_L2_IFETCH__S = 0x200, // Shared state
		L2_IFETCH__MASK__PPRO_L2_IFETCH__E = 0x400, // Exclusive state
		L2_IFETCH__MASK__PPRO_L2_IFETCH__M = 0x800, // Modified state
		L2_ST = 0x2a, // Number of L2 data stores. This event indicates that a normal
		L2_ST__MASK__PPRO_L2_IFETCH__I = 0x100, // Invalid state
		L2_ST__MASK__PPRO_L2_IFETCH__S = 0x200, // Shared state
		L2_ST__MASK__PPRO_L2_IFETCH__E = 0x400, // Exclusive state
		L2_ST__MASK__PPRO_L2_IFETCH__M = 0x800, // Modified state
		L2_M_LINES_INM = 0x25, // Number of modified lines allocated in the L2
		L2_RQSTS = 0x2e, // Total number of L2 requests
		L2_RQSTS__MASK__PPRO_L2_IFETCH__I = 0x100, // Invalid state
		L2_RQSTS__MASK__PPRO_L2_IFETCH__S = 0x200, // Shared state
		L2_RQSTS__MASK__PPRO_L2_IFETCH__E = 0x400, // Exclusive state
		L2_RQSTS__MASK__PPRO_L2_IFETCH__M = 0x800, // Modified state
		...
		BUS_DRDY_CLOCKS__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_DRDY_CLOCKS__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_LOCK_CLOCKS = 0x63, // Number of clocks during which LOCK# is asserted on the external system bus
		BUS_LOCK_CLOCKS__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_LOCK_CLOCKS__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		...
		BUS_TRANS_BRD__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_BRD__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_RFO = 0x66, // Number of completed read for ownership transactions
		BUS_TRANS_RFO__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_RFO__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_WB = 0x67, // Number of completed write back transactions
		BUS_TRANS_WB__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_WB__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_IFETCH = 0x68, // Number of completed instruction fetch transactions
		BUS_TRAN_IFETCH__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_IFETCH__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_INVAL = 0x69, // Number of completed invalidate transactions
		BUS_TRAN_INVAL__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_INVAL__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_PWR = 0x6a, // Number of completed partial write transactions
		BUS_TRAN_PWR__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_PWR__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_P = 0x6b, // Number of completed partial transactions
		BUS_TRANS_P__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_P__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_IO = 0x6c, // Number of completed I/O transactions
		BUS_TRANS_IO__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_IO__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_DEF = 0x6d, // Number of completed deferred transactions
		BUS_TRAN_DEF__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_DEF__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_BURST = 0x6e, // Number of completed burst transactions
		BUS_TRAN_BURST__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_BURST__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		...
		BUS_TRAN_ANY__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_ANY__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_MEM = 0x6f, // Number of completed memory transactions
		BUS_TRAN_MEM__MASK__PPRO_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_MEM__MASK__PPRO_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		...
		L2_LD__MASK__PPRO_L2_IFETCH__I = 0x100, // Invalid state
		L2_LD__MASK__PPRO_L2_IFETCH__S = 0x200, // Shared state
		L2_LD__MASK__PPRO_L2_IFETCH__E = 0x400, // Exclusive state
		L2_LD__MASK__PPRO_L2_IFETCH__M = 0x800, // Modified state
...
namespace ppro = optkit::intel::ppro;