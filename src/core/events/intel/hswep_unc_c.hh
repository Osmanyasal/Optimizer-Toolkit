...
namespace optkit::intel{
	enum class hswep_unc_c : uint64_t {
		...
		UNC_C_LLC_VICTIMS_MASK_STATE_F = 0x800, // Lines in F state
		UNC_C_LLC_VICTIMS_MASK_MISS = 0x1000, // TBD
		...
		UNC_C_MISC_MASK_CVZERO_PREFETCH_VICTIM = 0x1000, // 0 (core valid)
		UNC_C_MISC_MASK_CVZERO_PREFETCH_MISS = 0x2000, // 0 (core valid)
		...
		UNC_C_RING_AD_USED_MASK_UP = 0x3300, // Up ring polarity filter
		UNC_C_RING_AD_USED_MASK_DOWN = 0xcc00, // Down ring polarity filter
		UNC_C_RING_AD_USED_MASK_ALL = 0xcc00, // up or down ring polarity filter
		...
		UNC_C_RING_AK_USED_MASK_UP = 0x3300, // Up ring polarity filter
		UNC_C_RING_AK_USED_MASK_DOWN = 0xcc00, // Down ring polarity filter
		UNC_C_RING_AK_USED_MASK_ALL = 0xcc00, // up or down ring polarity filter
		...
		UNC_C_RING_BL_USED_MASK_UP = 0x3300, // Up ring polarity filter
		UNC_C_RING_BL_USED_MASK_DOWN = 0xcc00, // Down ring polarity filter
		UNC_C_RING_BL_USED_MASK_ALL = 0xcc00, // up or down ring polarity filter
		...
		UNC_C_RING_IV_USED_MASK_ANY = 0x0f00, // Any filter
		UNC_C_RING_IV_USED_MASK_UP = 0x0300, // Filter on any up polarity
		UNC_C_RING_IV_USED_MASK_DN = 0x0c00, // Filter on any up polarity
		...
		UNC_C_RXR_INSERTS_MASK_PRQ = 0x1000, // PRQ
		UNC_C_RXR_INSERTS_MASK_PRQ_REJECTED = 0x2000, // PRQ rejected
		...
		UNC_C_RXR_IPQ_RETRY2_MASK_AD_SBO = 0x100, // Count number of time that a request from the IPQ was retried because it lacked credits to send an AD packet to SBO
		UNC_C_RXR_IPQ_RETRY2_MASK_TARGET = 0x100, // Count number of times that a request from the IPQ was retried filtered by the target NodeId
		...
		UNC_C_RXR_IRQ_RETRY2_MASK_AD_SBO = 0x100, // Count number of time that a request from the IRQ was retried because it lacked credits to send an AD packet to SBO
		UNC_C_RXR_IRQ_RETRY2_MASK_BL_SBO = 0x100, // Count number of time that a request from the IRQ was retried because it lacked credits to send an BL packet to SBO
		UNC_C_RXR_IRQ_RETRY2_MASK_TARGET = 0x100, // Count number of times that a request from the IRQ was retried filtered by the target NodeId
		...
		UNC_C_RXR_ISMQ_RETRY2_MASK_AD_SBO = 0x100, // Count number of time that a request from the ISMQ was retried because it lacked credits to send an AD packet to SBO
		UNC_C_RXR_ISMQ_RETRY2_MASK_BL_SBO = 0x100, // Count number of time that a request from the ISMQ was retried because it lacked credits to send an BL packet to SBO
		UNC_C_RXR_ISMQ_RETRY2_MASK_TARGET = 0x100, // Count number of times that a request from the ISMQ was retried filtered by the target NodeId
		...
		UNC_C_RXR_OCCUPANCY_MASK_PRQ = 0x1000, // PRQ
		UNC_C_RXR_OCCUPANCY_MASK_PRQ_REJECTED = 0x2000, // PRQ rejected
		...
		UNC_C_SBO_CREDITS_ACQUIRED_MASK_AD = 0x100, // for AD ring
		UNC_C_SBO_CREDITS_OCCUPANCY = 0x3e, // SBO credits occupancy
		UNC_C_SBO_CREDITS_OCCUPANCY_MASK_AD = 0x100, // for AD ring
