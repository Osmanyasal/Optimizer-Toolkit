...
namespace optkit::intel{
	enum class bdx_unc_i : uint64_t {
		...
		UNC_I_CACHE_TOTAL_OCCUPANCY_MASK_SOURCE = 0x200, // Total Write Cache Occupancy -- Select Source
		...
		UNC_I_MISC0_MASK_PF_TIMEOUT = 0x8000, // Misc Events - Set 0 -- Prefetch TimeOut
		UNC_I_MISC1 = 0x15, // TBD
		UNC_I_MISC1_MASK_DATA_THROTTLE = 0x8000, // Misc Events - Set 1 -- Data Throttled
		UNC_I_MISC1_MASK_LOST_FWD = 0x1000, // Misc Events - Set 1 --
		...
		UNC_I_TRANSACTIONS_MASK_ORDERINGQ = 0x4000, // Inbound Transaction Count -- Select Source via IRP orderingQ register
