...
namespace optkit_intel{
	enum class bdw : uint64_t {
		...
		BACLEARS_MASK_ANY = 0x1f00, // Number of front-end re-steers due to BPU misprediction
		...
		BR_MISP_EXEC_MASK_TAKEN_RETURN_NEAR = 0x8800, // Taken speculative and retired mispredicted direct returns
		...
		BR_MISP_RETIRED_MASK_RET = 0x800, // Number of mispredicted ret instructions retired
		...
		CYCLE_ACTIVITY_MASK_CYCLES_MEM_ANY = 0x0200 | (0x2 << INTEL_X86_CMASK_BIT), // Cycles with pending memory loads
		CYCLE_ACTIVITY_MASK_CYCLES_L1D_PENDING = 0x0800 | (0x8 << INTEL_X86_CMASK_BIT), // Cycles with pending L1D load cache misses
		CYCLE_ACTIVITY_MASK_STALLS_LDM_PENDING = 0x0600 | (0x6 << INTEL_X86_CMASK_BIT), // Executions stalls when there is at least one pending demand load request
		CYCLE_ACTIVITY_MASK_STALLS_L1D_PENDING = 0x0c00 | (0xc << INTEL_X86_CMASK_BIT), // Executions stalls while there is at least one L1D demand load outstanding
		CYCLE_ACTIVITY_MASK_STALLS_L2_PENDING = 0x0500 | (0x5 << INTEL_X86_CMASK_BIT), // Execution stalls while there is at least one L2 demand load pending outstanding
		CYCLE_ACTIVITY_MASK_STALLS_TOTAL = 0x0400 | (0x4 << INTEL_X86_CMASK_BIT), // Cycles during which no instructions were executed in the execution stage of the pipeline
		...
		DTLB_LOAD_MISSES_MASK_WALK_COMPLETED_2M_4M = 0x400, // Misses in all TLB levels causes a page walk of 2MB/4MB page sizes that completes
		DTLB_LOAD_MISSES_MASK_WALK_COMPLETED_1G = 0x800, // Misses in all TLB levels causes a page walk of 1GB page sizes that completes
		...
		DTLB_LOAD_MISSES_MASK_STLB_HIT_4K = 0x2000, // Misses that miss the DTLB and hit the STLB (4KB)
		DTLB_LOAD_MISSES_MASK_STLB_HIT_2M = 0x4000, // Misses that miss the DTLB and hit the STLB (2MB)
		...
		DTLB_STORE_MISSES_MASK_WALK_COMPLETED_2M_4M = 0x400, // Misses in all TLB levels causes a page walk of 2MB/4MB page sizes that completes
		DTLB_STORE_MISSES_MASK_WALK_COMPLETED_1G = 0x800, // Misses in all TLB levels causes a page walk of 1GB page sizes that completes
		...
		DTLB_STORE_MISSES_MASK_STLB_HIT_4K = 0x2000, // Misses that miss the DTLB and hit the STLB (4KB)
		DTLB_STORE_MISSES_MASK_STLB_HIT_2M = 0x4000, // Misses that miss the DTLB and hit the STLB (2MB)
		...
		ICACHE_MASK_IFDATA_STALL = 0x400, // Number of cycles where a code fetch is stalled due to L1 miss
		...
		INST_RETIRED_MASK_X87 = 0x200, // Number of FPU operations retired (instructions with no exceptions)
		...
		INT_MISC_MASK_RAT_STALL_CYCLES = 0x800, // Cycles when the Resource Allocation Table (RAT) external stall event is sent to the Instruction Decode Queue (IDQ) for the thread. Also includes cycles when the allocator is serving another thread
		...
		ITLB_MISSES_MASK_WALK_COMPLETED_4K = 0x200, // Misses in all TLB levels causes a page walk that completes (4KB)
		ITLB_MISSES_MASK_WALK_COMPLETED_2M_4M = 0x400, // Misses in all TLB levels causes a page walk that completes (2MB/4MB)
		ITLB_MISSES_MASK_WALK_COMPLETED_1G = 0x800, // Misses in all TLB levels causes a page walk that completes (1GB)
		...
		ITLB_MISSES_MASK_STLB_HIT_4K = 0x2000, // Misses that miss the DTLB and hit the STLB (4KB)
		ITLB_MISSES_MASK_STLB_HIT_2M = 0x4000, // Misses that miss the DTLB and hit the STLB (2MB)
		...
		L2_RQSTS_MASK_PF_MISS = 0x3800, // Requests from the L2 hardware prefetchers that miss L2 cache
		...
		MEM_LOAD_UOPS_L3_MISS_RETIRED_MASK_LOCAL_DRAM = 0x100, // Retired load uops missing L3 cache but hitting local memory (Precise Event)
		...
		MEM_LOAD_UOPS_LLC_MISS_RETIRED_MASK_LOCAL_DRAM = 0x100, // Retired load uops missing L3 cache but hitting local memory (Precise Event)
		...
		UOPS_EXECUTED_MASK_THREAD = 0x100, // Number of uops executed per thread each cycle
		...
		ARITH_MASK_FPU_DIV_ACTIVE = 0x0100, // Cycles when divider is busy execuing divide operations
		...
		FP_ARITH_MASK_SCALAR = 0x0300, // Number of SSE/AVX computational scalar floating-point instructions retired. Applies to SSE* and AVX* scalar
		...
		FP_ARITH_MASK_PACKED = 0x3c00, // Number of SSE/AVX computational packed floating-point instructions retired. Applies to SSE* and AVX*
		FP_ARITH_MASK_SINGLE = 0x2a00, // Number of SSE/AVX computational single precision floating-point instructions retired. Applies to SSE* and AVX*scalar
		FP_ARITH_MASK_DOUBLE = 0x1500, // Number of SSE/AVX computational double precision floating-point instructions retired. Applies to SSE* and AVX*scalar
		...
		FP_ARITH_INST_RETIRED_MASK_SCALAR = 0x0300, // Number of SSE/AVX computational scalar floating-point instructions retired. Applies to SSE* and AVX* scalar
		...
		FP_ARITH_INST_RETIRED_MASK_PACKED = 0x3c00, // Number of SSE/AVX computational packed floating-point instructions retired. Applies to SSE* and AVX*
		FP_ARITH_INST_RETIRED_MASK_SINGLE = 0x2a00, // Number of SSE/AVX computational single precision floating-point instructions retired. Applies to SSE* and AVX*scalar
		FP_ARITH_INST_RETIRED_MASK_DOUBLE = 0x1500, // Number of SSE/AVX computational double precision floating-point instructions retired. Applies to SSE* and AVX*scalar
		...
		UOPS_DISPATCHES_CANCELLED_MASK_SIMD_PRF = 0x0300, // Number of uops cancelled after they were dispatched from the scheduler to the execution units when the total number of physical register read ports exceeds the read bandwidth of the register file. This umask applies to instructions: DPPS
		...
		OFFCORE_RESPONSE_0_MASK_ANY_IFETCH = 0x24100, // Request: combination of PF_IFETCH | DMND_IFETCH | PF_LLC_IFETCH
		...
		OFFCORE_RESPONSE_0_MASK_ANY_RFO = 0x10300, // Request: combination of DMND_RFO | PF_RFO | PF_LLC_RFO
		...
		OFFCORE_RESPONSE_0_MASK_LLC_HITF = 1ULL << (20+8), // Supplier: counts L3 hits in F-state
		...
		OFFCORE_RESPONSE_0_MASK_L3_HIT = 0xfULL << (18+8), // Alias for L3_HITMESF
		OFFCORE_RESPONSE_0_MASK_LLC_HIT = 0xfULL << (18+8), // Alias for LLC_HITMESF
		OFFCORE_RESPONSE_0_MASK_L3_MISS_LOCAL = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_0_MASK_LLC_MISS_LOCAL = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_0_MASK_LLC_MISS_LOCAL_DRAM = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_0_MASK_L3_MISS = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_0_MASK_L3_MISS = 0xfULL << (26+8), // Supplier: counts L3 misses to local or remote DRAM
		OFFCORE_RESPONSE_0_MASK_L3_MISS_REMOTE_HOP0 = 0x1ULL << (27+8), // Supplier: counts L3 misses to remote DRAM with 0 hop
		OFFCORE_RESPONSE_0_MASK_L3_MISS_REMOTE_HOP0_DRAM = 0x1ULL << (27+8), // Supplier: counts L3 misses to remote DRAM with 0 hop
		OFFCORE_RESPONSE_0_MASK_L3_MISS_REMOTE_HOP1 = 0x1ULL << (28+8), // Supplier: counts L3 misses to remote DRAM with 1 hop
		OFFCORE_RESPONSE_0_MASK_L3_MISS_REMOTE_HOP1_DRAM = 0x1ULL << (28+8), // Supplier: counts L3 misses to remote DRAM with 1 hop
		OFFCORE_RESPONSE_0_MASK_L3_MISS_REMOTE_HOP2P = 0x1ULL << (29+8), // Supplier: counts L3 misses to remote DRAM with 2P hops
		OFFCORE_RESPONSE_0_MASK_L3_MISS_REMOTE_HOP2P_DRAM = 0x1ULL << (29+8), // Supplier: counts L3 misses to remote DRAM with 2P hops
		...
		OFFCORE_RESPONSE_1_MASK_ANY_IFETCH = 0x24100, // Request: combination of PF_IFETCH | DMND_IFETCH | PF_LLC_IFETCH
		...
		OFFCORE_RESPONSE_1_MASK_ANY_RFO = 0x10300, // Request: combination of DMND_RFO | PF_RFO | PF_LLC_RFO
		...
		OFFCORE_RESPONSE_1_MASK_LLC_HITF = 1ULL << (20+8), // Supplier: counts L3 hits in F-state
		...
		OFFCORE_RESPONSE_1_MASK_L3_HIT = 0xfULL << (18+8), // Alias for L3_HITMESF
		OFFCORE_RESPONSE_1_MASK_LLC_HIT = 0xfULL << (18+8), // Alias for LLC_HITMESF
		OFFCORE_RESPONSE_1_MASK_L3_MISS_LOCAL = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_1_MASK_LLC_MISS_LOCAL = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_1_MASK_LLC_MISS_LOCAL_DRAM = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_1_MASK_L3_MISS = 1ULL << (26+8), // Supplier: counts L3 misses to local DRAM
		OFFCORE_RESPONSE_1_MASK_L3_MISS = 0xfULL << (26+8), // Supplier: counts L3 misses to local or remote DRAM
		OFFCORE_RESPONSE_1_MASK_L3_MISS_REMOTE_HOP0 = 0x1ULL << (27+8), // Supplier: counts L3 misses to remote DRAM with 0 hop
		OFFCORE_RESPONSE_1_MASK_L3_MISS_REMOTE_HOP0_DRAM = 0x1ULL << (27+8), // Supplier: counts L3 misses to remote DRAM with 0 hop
		OFFCORE_RESPONSE_1_MASK_L3_MISS_REMOTE_HOP1 = 0x1ULL << (28+8), // Supplier: counts L3 misses to remote DRAM with 1 hop
		OFFCORE_RESPONSE_1_MASK_L3_MISS_REMOTE_HOP1_DRAM = 0x1ULL << (28+8), // Supplier: counts L3 misses to remote DRAM with 1 hop
		OFFCORE_RESPONSE_1_MASK_L3_MISS_REMOTE_HOP2P = 0x1ULL << (29+8), // Supplier: counts L3 misses to remote DRAM with 2P hops
		OFFCORE_RESPONSE_1_MASK_L3_MISS_REMOTE_HOP2P_DRAM = 0x1ULL << (29+8), // Supplier: counts L3 misses to remote DRAM with 2P hops
