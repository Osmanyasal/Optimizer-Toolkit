...
namespace optkit::intel::snb{
	enum snb : uint64_t {
		...
		OFFCORE_RESPONSE_0__MASK__SNB_OFFCORE_RESPONSE__L3_MISS__REPEAT__1 = 0x3ULL << (22+8), // Supplier: counts L3 misses to local or remote DRAM
		...
		OFFCORE_RESPONSE_1__MASK__SNB_OFFCORE_RESPONSE__L3_MISS__REPEAT__1 = 0x3ULL << (22+8), // Supplier: counts L3 misses to local or remote DRAM
...
namespace snb = optkit::intel::snb;