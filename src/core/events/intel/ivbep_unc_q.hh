...
namespace optkit::intel{
	enum class ivbep_unc_q : uint64_t {
		...
		UNC_Q_DIRECT2CORE_MASK_FAILURE_CREDITS = 0x200, // Number of spawn failures due to lack of Egress credits
		UNC_Q_DIRECT2CORE_MASK_FAILURE_CREDITS_RBT = 0x800, // Number of spawn failures due to lack of Egress credit and route-back table (RBT) bit was not set
		UNC_Q_DIRECT2CORE_MASK_FAILURE_RBT_HIT = 0x400, // Number of spawn failures because route-back table (RBT) specified that the transaction should not trigger a direct2core transaction
		UNC_Q_DIRECT2CORE_MASK_SUCCESS_RBT_HIT = 0x100, // Number of spawn successes
		UNC_Q_DIRECT2CORE_MASK_FAILURE_MISS = 0x1000, // Number of spawn failures due to RBT tag not matching although the valid bit was set and there was enough Egress credits
		UNC_Q_DIRECT2CORE_MASK_FAILURE_CREDITS_MISS = 0x2000, // Number of spawn failures due to RBT tag not matching and they were not enough Egress credits. The valid bit was set
		UNC_Q_DIRECT2CORE_MASK_FAILURE_RBT_MISS = 0x4000, // Number of spawn failures due to RBT tag not matching
		UNC_Q_DIRECT2CORE_MASK_FAILURE_CREDITS_RBT_MISS = 0x8000, // Number of spawn failures due to RBT tag not matching
		...
		UNC_Q_RXL_CREDITS_CONSUMED_VN0_MASK_DRS = 0x100, // Number of times VN0 consumed for DRS message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN0_MASK_HOM = 0x800, // Number of times VN0 consumed for HOM message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN0_MASK_NCB = 0x200, // Number of times VN0 consumed for NCB message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN0_MASK_NCS = 0x400, // Number of times VN0 consumed for NCS message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN0_MASK_NDR = 0x2000, // Number of times VN0 consumed for NDR message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN0_MASK_SNP = 0x1000, // Number of times VN0 consumed for SNP message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN1 = 0x39 | (1ULL << 21), // VN1 Credit Consumed
		UNC_Q_RXL_CREDITS_CONSUMED_VN1_MASK_DRS = 0x100, // Number of times VN1 consumed for DRS message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN1_MASK_HOM = 0x800, // Number of times VN1 consumed for HOM message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN1_MASK_NCB = 0x200, // Number of times VN1 consumed for NCB message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN1_MASK_NCS = 0x400, // Number of times VN1 consumed for NCS message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN1_MASK_NDR = 0x2000, // Number of times VN1 consumed for NDR message class
		UNC_Q_RXL_CREDITS_CONSUMED_VN1_MASK_SNP = 0x1000, // Number of times VN1 consumed for SNP message class
		...
		UNC_Q_RXL_FLITS_G0_MASK_IDLE = 0x100, // Number of flits over QPI that do not hold protocol payload
		...
		UNC_Q_RXL_FLITS_G1_MASK_DRS = 0x1800, // Number of flits over QPI on the Data Response (DRS) channel
		UNC_Q_RXL_FLITS_G1_MASK_DRS_DATA = 0x800, // Number of data flits over QPI on the Data Response (DRS) channel
		UNC_Q_RXL_FLITS_G1_MASK_DRS_NONDATA = 0x1000, // Number of protocol flits over QPI on the Data Response (DRS) channel
		UNC_Q_RXL_FLITS_G1_MASK_HOM = 0x600, // Number of flits over QPI on the home channel
		UNC_Q_RXL_FLITS_G1_MASK_HOM_NONREQ = 0x400, // Number of non-request flits over QPI on the home channel
		UNC_Q_RXL_FLITS_G1_MASK_HOM_REQ = 0x200, // Number of data requests over QPI on the home channel
		UNC_Q_RXL_FLITS_G1_MASK_SNP = 0x100, // Number of snoop requests flits over QPI
		UNC_Q_RXL_FLITS_G2 = 0x3 | (1ULL << 21), // Flits Received - Group 2
		UNC_Q_RXL_FLITS_G2_MASK_NCB = 0xc00, // Number of non-coherent bypass flits
		UNC_Q_RXL_FLITS_G2_MASK_NCB_DATA = 0x400, // Number of non-coherent data flits
		UNC_Q_RXL_FLITS_G2_MASK_NCB_NONDATA = 0x800, // Number of bypass non-data flits
		UNC_Q_RXL_FLITS_G2_MASK_NCS = 0x1000, // Number of non-coherent standard (NCS) flits
		UNC_Q_RXL_FLITS_G2_MASK_NDR_AD = 0x100, // Number of flits received over Non-data response (NDR) channel
		UNC_Q_RXL_FLITS_G2_MASK_NDR_AK = 0x200, // Number of flits received on the Non-data response (NDR) channel)
		...
		UNC_Q_TXL_FLITS_G0_MASK_DATA = 0x200, // Number of data flits over QPI
		UNC_Q_TXL_FLITS_G0_MASK_NON_DATA = 0x400, // Number of non-NULL non-data flits over QPI
		UNC_Q_TXL_FLITS_G1 = 0x0 | (1ULL << 21), // Flits Transferred - Group 1
		UNC_Q_TXL_FLITS_G1_MASK_DRS = 0x1800, // Number of flits over QPI on the Data Response (DRS) channel
		UNC_Q_TXL_FLITS_G1_MASK_DRS_DATA = 0x800, // Number of data flits over QPI on the Data Response (DRS) channel
		UNC_Q_TXL_FLITS_G1_MASK_DRS_NONDATA = 0x1000, // Number of protocol flits over QPI on the Data Response (DRS) channel
		UNC_Q_TXL_FLITS_G1_MASK_HOM = 0x600, // Number of flits over QPI on the home channel
		UNC_Q_TXL_FLITS_G1_MASK_HOM_NONREQ = 0x400, // Number of non-request flits over QPI on the home channel
		UNC_Q_TXL_FLITS_G1_MASK_HOM_REQ = 0x200, // Number of data requests over QPI on the home channel
		UNC_Q_TXL_FLITS_G1_MASK_SNP = 0x100, // Number of snoop requests flits over QPI
		UNC_Q_TXL_FLITS_G2 = 0x1 | (1ULL << 21), // Flits Transferred - Group 2
		UNC_Q_TXL_FLITS_G2_MASK_NCB = 0xc00, // Number of non-coherent bypass flits
		UNC_Q_TXL_FLITS_G2_MASK_NCB_DATA = 0x400, // Number of non-coherent data flits
		UNC_Q_TXL_FLITS_G2_MASK_NCB_NONDATA = 0x800, // Number of bypass non-data flits
		UNC_Q_TXL_FLITS_G2_MASK_NCS = 0x1000, // Number of non-coherent standard (NCS) flits
		UNC_Q_TXL_FLITS_G2_MASK_NDR_AD = 0x100, // Number of flits received over Non-data response (NDR) channel
		UNC_Q_TXL_FLITS_G2_MASK_NDR_AK = 0x200, // Number of flits received on the Non-data response (NDR) channel)
		...
		UNC_Q_TXR_AK_NDR_CREDIT_ACQUIRED_MASK_VN0 = 0x100, // for VN0
		UNC_Q_TXR_AK_NDR_CREDIT_ACQUIRED_MASK_VN1 = 0x200, // for VN1
		UNC_Q_TXR_AK_NDR_CREDIT_OCCUPANCY = 0x25 | (1ULL << 21), // R3QPI Egress credit occupancy AD NDR
		UNC_Q_TXR_AK_NDR_CREDIT_OCCUPANCY_MASK_VN0 = 0x100, // for VN0
		UNC_Q_TXR_AK_NDR_CREDIT_OCCUPANCY_MASK_VN1 = 0x200, // for VN1
		UNC_Q_TXR_BL_DRS_CREDIT_ACQUIRED = 0x2a | (1ULL << 21), // R3QPI Egress credit occupancy BL DRS
		UNC_Q_TXR_BL_DRS_CREDIT_ACQUIRED_MASK_VN0 = 0x100, // for VN0
		UNC_Q_TXR_BL_DRS_CREDIT_ACQUIRED_MASK_VN1 = 0x200, // for VN1
		UNC_Q_TXR_BL_DRS_CREDIT_ACQUIRED_MASK_VN_SHR = 0x400, // for shared VN
		UNC_Q_TXR_BL_DRS_CREDIT_OCCUPANCY = 0x1f | (1ULL << 21), // R3QPI Egress credit occupancy BL DRS
		UNC_Q_TXR_BL_DRS_CREDIT_OCCUPANCY_MASK_VN0 = 0x100, // for VN0
		UNC_Q_TXR_BL_DRS_CREDIT_OCCUPANCY_MASK_VN1 = 0x200, // for VN1
		UNC_Q_TXR_BL_DRS_CREDIT_OCCUPANCY_MASK_VN_SHR = 0x400, // for shared VN
