...
namespace optkit::intel::pm{
	enum pm : uint64_t {
		...
		L2_IFETCH__MASK__PM_L2_IFETCH__I = 0x100, // Invalid state
		L2_IFETCH__MASK__PM_L2_IFETCH__S = 0x200, // Shared state
		L2_IFETCH__MASK__PM_L2_IFETCH__E = 0x400, // Exclusive state
		L2_IFETCH__MASK__PM_L2_IFETCH__M = 0x800, // Modified state
		L2_ST = 0x2a, // Number of L2 data stores. This event indicates that a normal
		L2_ST__MASK__PM_L2_IFETCH__I = 0x100, // Invalid state
		L2_ST__MASK__PM_L2_IFETCH__S = 0x200, // Shared state
		L2_ST__MASK__PM_L2_IFETCH__E = 0x400, // Exclusive state
		L2_ST__MASK__PM_L2_IFETCH__M = 0x800, // Modified state
		L2_M_LINES_INM = 0x25, // Number of modified lines allocated in the L2
		L2_RQSTS = 0x2e, // Total number of L2 requests
		L2_RQSTS__MASK__PM_L2_IFETCH__I = 0x100, // Invalid state
		L2_RQSTS__MASK__PM_L2_IFETCH__S = 0x200, // Shared state
		L2_RQSTS__MASK__PM_L2_IFETCH__E = 0x400, // Exclusive state
		L2_RQSTS__MASK__PM_L2_IFETCH__M = 0x800, // Modified state
		...
		BUS_DRDY_CLOCKS__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_DRDY_CLOCKS__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_LOCK_CLOCKS = 0x63, // Number of clocks during which LOCK# is asserted on the external system bus
		BUS_LOCK_CLOCKS__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_LOCK_CLOCKS__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		...
		BUS_TRANS_BRD__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_BRD__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_RFO = 0x66, // Number of completed read for ownership transactions
		BUS_TRANS_RFO__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_RFO__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_WB = 0x67, // Number of completed write back transactions
		BUS_TRANS_WB__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_WB__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_IFETCH = 0x68, // Number of completed instruction fetch transactions
		BUS_TRAN_IFETCH__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_IFETCH__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_INVAL = 0x69, // Number of completed invalidate transactions
		BUS_TRAN_INVAL__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_INVAL__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_PWR = 0x6a, // Number of completed partial write transactions
		BUS_TRAN_PWR__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_PWR__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_P = 0x6b, // Number of completed partial transactions
		BUS_TRANS_P__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_P__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRANS_IO = 0x6c, // Number of completed I/O transactions
		BUS_TRANS_IO__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRANS_IO__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_DEF = 0x6d, // Number of completed deferred transactions
		BUS_TRAN_DEF__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_DEF__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_BURST = 0x6e, // Number of completed burst transactions
		BUS_TRAN_BURST__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_BURST__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		...
		BUS_TRAN_ANY__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_ANY__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		BUS_TRAN_MEM = 0x6f, // Number of completed memory transactions
		BUS_TRAN_MEM__MASK__PM_BUS_DRDY_CLOCKS__SELF = 0x0, // Clocks when processor is driving bus
		BUS_TRAN_MEM__MASK__PM_BUS_DRDY_CLOCKS__ANY = 0x2000, // Clocks when any agent is driving bus
		...
		MMX_INSTR_TYPE_EXEC__MASK__PM_MMX_INSTR_TYPE_EXEC__MUL = 0x100, // MMX packed multiply instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__PM_MMX_INSTR_TYPE_EXEC__SHIFT = 0x200, // MMX packed shift instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__PM_MMX_INSTR_TYPE_EXEC__PACK = 0x400, // MMX pack operation instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__PM_MMX_INSTR_TYPE_EXEC__UNPACK = 0x800, // MMX unpack operation instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__PM_MMX_INSTR_TYPE_EXEC__LOGICAL = 0x1000, // MMX packed logical instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__PM_MMX_INSTR_TYPE_EXEC__ARITH = 0x2000, // MMX packed arithmetic instructions executed
		FP_MMX_TRANS = 0xcc, // Number of MMX transitions
		FP_MMX_TRANS__MASK__PM_FP_MMX_TRANS__TO_FP = 0x0, // From MMX instructions to floating-point instructions
		FP_MMX_TRANS__MASK__PM_FP_MMX_TRANS__TO_MMX = 0x100, // From floating-point instructions to MMX instructions
		MMX_ASSIST = 0xcd, // Number of MMX micro-ops executed
		SEG_RENAME_STALLS = 0xd4, // Number of Segment Register Renaming Stalls
		SEG_RENAME_STALLS__MASK__PM_SEG_RENAME_STALLS__ES = 0x100, // Segment register ES
		SEG_RENAME_STALLS__MASK__PM_SEG_RENAME_STALLS__DS = 0x200, // Segment register DS
		SEG_RENAME_STALLS__MASK__PM_SEG_RENAME_STALLS__FS = 0x400, // Segment register FS
		SEG_RENAME_STALLS__MASK__PM_SEG_RENAME_STALLS__GS = 0x800, // Segment register GS
		SEG_REG_RENAMES = 0xd5, // Number of Segment Register Renames
		SEG_REG_RENAMES__MASK__PM_SEG_RENAME_STALLS__ES = 0x100, // Segment register ES
		SEG_REG_RENAMES__MASK__PM_SEG_RENAME_STALLS__DS = 0x200, // Segment register DS
		SEG_REG_RENAMES__MASK__PM_SEG_RENAME_STALLS__FS = 0x400, // Segment register FS
		SEG_REG_RENAMES__MASK__PM_SEG_RENAME_STALLS__GS = 0x800, // Segment register GS
		...
		EMON_KNI_PREF_DISPATCHED__MASK__PM_EMON_KNI_PREF_DISPATCHED__NTA = 0x0, // Prefetch NTA
		EMON_KNI_PREF_DISPATCHED__MASK__PM_EMON_KNI_PREF_DISPATCHED__T1 = 0x100, // Prefetch T1
		EMON_KNI_PREF_DISPATCHED__MASK__PM_EMON_KNI_PREF_DISPATCHED__T2 = 0x200, // Prefetch T2
		EMON_KNI_PREF_DISPATCHED__MASK__PM_EMON_KNI_PREF_DISPATCHED__WEAK = 0x300, // Weakly ordered stores
		EMON_KNI_PREF_MISS = 0x4b, // Number of prefetch/weakly-ordered instructions that miss all caches. Pentium III and later
		EMON_KNI_PREF_MISS__MASK__PM_EMON_KNI_PREF_DISPATCHED__NTA = 0x0, // Prefetch NTA
		EMON_KNI_PREF_MISS__MASK__PM_EMON_KNI_PREF_DISPATCHED__T1 = 0x100, // Prefetch T1
		EMON_KNI_PREF_MISS__MASK__PM_EMON_KNI_PREF_DISPATCHED__T2 = 0x200, // Prefetch T2
		EMON_KNI_PREF_MISS__MASK__PM_EMON_KNI_PREF_DISPATCHED__WEAK = 0x300, // Weakly ordered stores
		EMON_EST_TRANS = 0x58, // Number of Enhanced Intel SpeedStep technology transitions
		EMON_EST_TRANS__MASK__PM_EMON_EST_TRANS__ALL = 0x0, // All transitions
		EMON_EST_TRANS__MASK__PM_EMON_EST_TRANS__FREQ = 0x200, // Only frequency transitions
		...
		EMON_FUSED_UOPS_RET__MASK__PM_EMON_FUSED_UOPS_RET__ALL = 0x0, // All fused micro-ops
		EMON_FUSED_UOPS_RET__MASK__PM_EMON_FUSED_UOPS_RET__LD_OP = 0x100, // Only load+Op micro-ops
		EMON_FUSED_UOPS_RET__MASK__PM_EMON_FUSED_UOPS_RET__STD_STA = 0x200, // Only std+sta micro-ops
		...
		EMON_SSE_SSE2_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE_PACKED_SCALAR_SINGLE = 0x0, // SSE Packed Single and Scalar Single
		EMON_SSE_SSE2_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE_SCALAR_SINGLE = 0x100, // SSE Scalar Single
		EMON_SSE_SSE2_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE2_PACKED_DOUBLE = 0x200, // SSE2 Packed Double
		EMON_SSE_SSE2_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE2_SCALAR_DOUBLE = 0x300, // SSE2 Scalar Double
		EMON_SSE_SSE2_COMP_INST_RETIRED = 0xd9, // Computational SSE instructions retired
		EMON_SSE_SSE2_COMP_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE_PACKED_SCALAR_SINGLE = 0x0, // SSE Packed Single and Scalar Single
		EMON_SSE_SSE2_COMP_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE_SCALAR_SINGLE = 0x100, // SSE Scalar Single
		EMON_SSE_SSE2_COMP_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE2_PACKED_DOUBLE = 0x200, // SSE2 Packed Double
		EMON_SSE_SSE2_COMP_INST_RETIRED__MASK__PM_EMON_SSE_SSE2_INST_RETIRED__SSE2_SCALAR_DOUBLE = 0x300, // SSE2 Scalar Double
		L2_LD = 0x29, // Number of L2 data loads
		L2_LD__MASK__PM_L2_LD__I = 0x100, // Invalid state
		L2_LD__MASK__PM_L2_LD__S = 0x200, // Shared state
		L2_LD__MASK__PM_L2_LD__E = 0x400, // Exclusive state
		L2_LD__MASK__PM_L2_LD__M = 0x800, // Modified state
		L2_LD__MASK__PM_L2_LD__EXCL_HW_PREFETCH = 0x0, // Exclude hardware prefetched lines
		L2_LD__MASK__PM_L2_LD__ONLY_HW_PREFETCH = 0x1000, // Only hardware prefetched lines
		L2_LD__MASK__PM_L2_LD__NON_HW_PREFETCH = 0x2000, // Non hardware prefetched lines
		L2_LINES_IN = 0x24, // Number of L2 lines allocated
		L2_LINES_IN__MASK__PM_L2_LD__I = 0x100, // Invalid state
		L2_LINES_IN__MASK__PM_L2_LD__S = 0x200, // Shared state
		L2_LINES_IN__MASK__PM_L2_LD__E = 0x400, // Exclusive state
		L2_LINES_IN__MASK__PM_L2_LD__M = 0x800, // Modified state
		L2_LINES_IN__MASK__PM_L2_LD__EXCL_HW_PREFETCH = 0x0, // Exclude hardware prefetched lines
		L2_LINES_IN__MASK__PM_L2_LD__ONLY_HW_PREFETCH = 0x1000, // Only hardware prefetched lines
		L2_LINES_IN__MASK__PM_L2_LD__NON_HW_PREFETCH = 0x2000, // Non hardware prefetched lines
		L2_LINES_OUT = 0x26, // Number of L2 lines evicted
		L2_LINES_OUT__MASK__PM_L2_LD__I = 0x100, // Invalid state
		L2_LINES_OUT__MASK__PM_L2_LD__S = 0x200, // Shared state
		L2_LINES_OUT__MASK__PM_L2_LD__E = 0x400, // Exclusive state
		L2_LINES_OUT__MASK__PM_L2_LD__M = 0x800, // Modified state
		L2_LINES_OUT__MASK__PM_L2_LD__EXCL_HW_PREFETCH = 0x0, // Exclude hardware prefetched lines
		L2_LINES_OUT__MASK__PM_L2_LD__ONLY_HW_PREFETCH = 0x1000, // Only hardware prefetched lines
		L2_LINES_OUT__MASK__PM_L2_LD__NON_HW_PREFETCH = 0x2000, // Non hardware prefetched lines
		L2_M_LINES_OUT = 0x27, // Number of L2 M-state lines evicted
		L2_M_LINES_OUT__MASK__PM_L2_LD__I = 0x100, // Invalid state
		L2_M_LINES_OUT__MASK__PM_L2_LD__S = 0x200, // Shared state
		L2_M_LINES_OUT__MASK__PM_L2_LD__E = 0x400, // Exclusive state
		L2_M_LINES_OUT__MASK__PM_L2_LD__M = 0x800, // Modified state
		L2_M_LINES_OUT__MASK__PM_L2_LD__EXCL_HW_PREFETCH = 0x0, // Exclude hardware prefetched lines
		L2_M_LINES_OUT__MASK__PM_L2_LD__ONLY_HW_PREFETCH = 0x1000, // Only hardware prefetched lines
		L2_M_LINES_OUT__MASK__PM_L2_LD__NON_HW_PREFETCH = 0x2000, // Non hardware prefetched lines
