...
namespace optkit_intel{
	enum class p6 : uint64_t {
		...
		EMON_KNI_INST_RETIRED_MASK_PACKED_SCALAR = 0x0, // Packed and scalar instructions
		EMON_KNI_INST_RETIRED_MASK_SCALAR = 0x100, // Scalar only
		EMON_KNI_COMP_INST_RET = 0xd9, // Number of SSE computation instructions retired. Pentium III and later
		EMON_KNI_COMP_INST_RET_MASK_PACKED_SCALAR = 0x0, // Packed and scalar instructions
		EMON_KNI_COMP_INST_RET_MASK_SCALAR = 0x100, // Scalar only
		};};